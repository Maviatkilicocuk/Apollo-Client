...
const resolvers = {
  Subscription: {
    ...
    userUpdated: {
      subscribe: () => pubsub.subscribe("USER_UPDATED"),
    },
    userDeleted: {
      subscribe: () => pubsub.subscribe("USER_DELETED"),
    },
    userCount: {
      subscribe: (parent, args, { pubsub }) => {
        ...
        return pubsub.subscribe("USER_COUNT");
      },
    },
    ...
    eventCreated: {
      subscribe: withFilter(
        () => pubsub.subscribe("EVENT_CREATED"),
        (payload, variables) => {
    ...
    eventUpdated: {
      subscribe: () => pubsub.subscribe("EVENT_UPDATED"),
    },
    eventDeleted: {
      subscribe: () => pubsub.subscribe("EVENT_DELETED"),
    },
    // Location
    locationCreated: {
      subscribe: () => pubsub.subscribe("LOCATION_CREATED"),
    },
    locationUpdated: {
      subscribe: () => pubsub.subscribe("LOCATION_UPDATED"),
    },
    locationDeleted: {
      subscribe: () => pubsub.subscribe("LOCATION_DELETED"),
    },
    // Participant
    participantCreated: {
      subscribe: withFilter(
        () => pubsub.subscribe("PARTICIPANT_CREATED"),
        (payload, variables) => {
    ...
    participantUpdated: {
      subscribe: () => pubsub.subscribe("PARTICIPANT_UPDATED"),
    },
    participantDeleted: {
      subscribe: () => pubsub.subscribe("PARTICIPANT_DELETED"),
    },
  },
